#include <ESP8266WiFi.h>  // Using Esp8266 2.4.2
...
// Define LED pins
const int SOUND_PIN = 13; // D7
const int BUZZ_PIN = 5; // D1
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (message == "S") {
    ...
    digitalWrite(BUZZ_PIN, HIGH); // Turn on transistor
    delay(2000); // Wait for 2 seconds
    digitalWrite(BUZZ_PIN, LOW); // Turn off transistor
  }
}
...
void setup() {
  ...
  espClient.setCACert((const uint8_t*)root_ca, sizeof(root_ca) - 1);
